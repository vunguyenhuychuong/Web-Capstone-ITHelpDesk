...
const DetailTicket = () => {
  ...
  return (
    ...
    >
      <MDBContainer className="left-box">
          ...
          <MDBTable bordered>
            <MDBTableBody>
              ...
              <tr>
                ...
                <td className="align-left">{data.scheduledStartTime || "-"}</td>
                <td className="gray-background align-right">
                  ScheduledEndTime{" "}
                </td>
              ...
              <tr>
                ...
                <td className="align-left">{data.dueTime || "-"}</td>
                <td className="gray-background align-right">Completed Time </td>
      ...
      <MDBContainer className="right-box">
        <MDBRow className="border-box">
          <MDBCol md="12">
            <div className="d-flex">
