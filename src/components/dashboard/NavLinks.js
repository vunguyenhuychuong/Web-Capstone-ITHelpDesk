  ...
  if (roleUser === 1) {
    filteredLink = links.filter(
      (link) =>
        link.id === 7 ||
        link.id === 18 ||
        (isCompanyAdmin && link.id === 28) ||
        (isCompanyAdmin && link.id === 30)
    );
  } else if (roleUser === 0) {
    filteredLink = links.filter(
      (link) => link.id === 20 || link.id === 3 || link.id === 5
    );
  } else if (roleUser === 2) {
    filteredLink = links.filter(
      (link) =>
    ...
    filteredLink = links.filter(
      (link) => link.id === 13 || link.id === 10 || link.id === 24
    );
  } else if (roleUser === 4) {
    filteredLink = links.filter((link) => link.id === 22 || link.id === 21);
  }
