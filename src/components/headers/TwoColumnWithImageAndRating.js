...
const TextColumn = styled(Column)(props => [
  tw`md:w-4/12 xl:w-4/12 mt-16 md:mt-0`,
  props.textOnLeft ? tw`md:pr-8 lg:pr-8 md:order-first` : tw`md:pl-8 lg:pl-8 md:order-last`
]);
...
const Description = tw.p`mt-6 text-center md:text-left text-sm md:text-base lg:text-lg font-medium leading-relaxed text-primary-500`;
...
const CustomerTextInfo = tw.div`text-center md:text-left sm:ml-2 mt-2 sm:mt-0`;
...
const ControlButton = styled.button`
  ${tw`mx-3 p-4 rounded-full transition duration-300 bg-gray-200 hover:bg-gray-300 text-gray-500 hover:text-gray-700 focus:outline-none focus:outline`}
  svg {
    ${tw`w-4 h-4 stroke-2`}
  }
`;
