...
const Description = tw.p`mt-8 text-center md:text-left text-sm md:text-base lg:text-lg font-medium leading-relaxed text-primary-500`;
...
const FeatureIconContainer = styled.div`
  ${tw`mx-auto inline-block border border-gray-500 text-primary-500 text-center rounded p-2 flex-shrink-0`}
  ${props => [
    props.iconRoundedFull && tw`rounded-full`,
    props.iconFilled && tw`border-0 bg-gray-500 text-primary-100`
  ]}
  svg {
    ${tw`w-5 h-5`}
  }
...
export default TwoColumnHorizon;
