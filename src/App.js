    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/home" element={<SharedLayout />}>
          ...
          {(hasCustomerRole || hasManagerRole) && (
          ...
          {(hasCustomerRole || hasManagerRole || hasTechnicianRole) && (
          ...
          {(hasCustomerRole || hasManagerRole || hasTechnicianRole) && (
            <Route
              path="editTicketCustomer/:ticketId"
              element={<EditTicketCustomer />}
            />
          )}
          {(hasCustomerRole || hasManagerRole || hasTechnicianRole) && (
            <Route path="ticketSolution" element={<TicketSolutionList />} />
          )}
          {(hasTechnicianRole || hasManagerRole) && (
            <Route path="createSolution" element={<CreateTicketSolution />} />
          )}
          {(hasTechnicianRole || hasManagerRole) && (
            <Route
              path="editSolution/:solutionId"
              element={<EditTicketSolution />}
            />
          )}
          {(hasCustomerRole || hasManagerRole || hasTechnicianRole) && (
            <Route
          ...
          {(hasManagerRole || hasTechnicianRole) && (
          ...
          {(hasManagerRole || hasTechnicianRole) && (
            <Route path="listTicket" element={<ManagersTabs />} />
          )}
          {hasTechnicianRole && (
            <Route
              path="ticketAssign"
              element={<TicketAssignAvailableList />}
            />
          )}
          {hasManagerRole && (
          ...
          {(hasManagerRole || hasAccountantRole) && (
          ...
          {(hasManagerRole || hasAccountantRole) && (
            <Route
              path="createRenewContract/:contractId"
              element={<CreateRenewContract />}
            />
          )}
          {(hasManagerRole || hasAccountantRole) && (
            <Route
          ...
          {hasManagerRole && (
            <Route
              path="editTeamMember/:teamMemberId"
